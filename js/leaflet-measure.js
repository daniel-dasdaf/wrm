...
(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _createControl: function (label, title, classesToAdd, container, fn, context) {
            ...
            anchor.innerHTML = "Start your course";
            anchor.setAttribute('title', title);
            classesToAdd.forEach(function(c) {
                anchor.classList.add('map__input', 'map__multiple__inputs');
            });
            anchor.type = "button"
            L.DomEvent.on (anchor, 'click', fn, context);
            runForm.appendChild(anchor);
            return anchor;
        },
        ...
        _mouseClick: function (e) {
            ...
            // DASDAF -> added "this._arrPolylines.length > 0" so the user couldn't add more polylines.
            if (!e.latlng || (this._finishCircleScreencoords && this._finishCircleScreencoords.equals(e.containerPoint)) || this._arrPolylines.length > 0) {
                return;
            }
